...
membershipStartDate TEXT NOT NULL CHECK (membershipStartDate GLOB '???-??-??'),
membershipEndDate TEXT NOT NULL CHECK (membershipEndDate GLOB '????-??-??' AND membershipEndDate >= membershipStartDate)
);
...
paymentDate TEXT NOT NULL CHECK (paymentDate LIKE '____-__-__'),
...
attendanceDate TEXT NOT NULL CHECK (attendanceDate LIKE '____-__-__'),
